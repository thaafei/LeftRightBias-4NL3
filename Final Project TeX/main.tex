...
\midrule
Baseline & --- & 0.272\textsuperscript{*} & --- \\
DistilBERT & 0.576 & 0.530 & 0.425 \\
Flan-T5 (zero-shot) & 0.455 & --- & --- \\
MiniLM & 0.552 & 0.526 & 0.483 \\
\bottomrule
\end{tabular}
\caption{Model results. DistilBERT is evaluated on the validation set (92 samples); MiniLM and Flan-T5 on the test set (279 samples). F1\textsubscript{W} = weighted F1; F1\textsubscript{M} = macro F1. \textsuperscript{*}Baseline reports micro F1 from Codabench.}
\label{tab:results}
\end{table}
